...
const readUsers = (req, res, next) => {
  const query = utils.parseJson(req.query.query);
  const projection = utils.parseJson(req.query.projection) || {};
...
const loginUser = (req, res, next) => {
  const query = utils.parseJson(req.query.query);
  const password = utils.parseJson(req.query.password).toString();
...
const getContactList = (req, res, next) => {
  const userId = utils.parseJson(req.query.userId);
